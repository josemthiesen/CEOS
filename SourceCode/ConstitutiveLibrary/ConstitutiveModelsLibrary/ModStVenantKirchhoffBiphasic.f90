...
module ModStVenantKirchhoffBiphasic
    ...
    type , extends(ClassStVenantKirchhoffBiphasic) :: ClassStVenantKirchhoffBiphasic_PlaneStrain
         ...
         contains
            ...
            !----------------------------------------------------------------------------------
             ...
             procedure :: UpdateStressAndStateVariables  =>  UpdateStressAndStateVariables_StVenantKirchhoffB_PS
             procedure :: GetTangentModulus              =>  GetTangentModulus_StVenantKirchhoffBiphasic_PS
    ...
    type , extends(ClassStVenantKirchhoffBiphasic) :: ClassStVenantKirchhoffBiphasic_Axisymmetric
         ...
         contains
            ...
            !----------------------------------------------------------------------------------
             ...
             procedure :: UpdateStressAndStateVariables  =>  UpdateStressAndStateVariables_StVenantKirchhoffB_Axi
             procedure :: GetTangentModulus              =>  GetTangentModulus_StVenantKirchhoffBiphasic_Axi
    ...
    contains
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine UpdateStressAndStateVariables_StVenantKirchhoffB_PS(this,Status)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine GetTangentModulus_StVenantKirchhoffBiphasic_PS(this,D)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine UpdateStressAndStateVariables_StVenantKirchhoffB_Axi(this,Status)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine GetTangentModulus_StVenantKirchhoffBiphasic_Axi(this,D)
